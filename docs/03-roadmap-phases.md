...
- Tester différents horaires de commande (heure limite le matin) et différents types de plats (portion individuelle, facile à manger au bureau).
...
- **Vérifier directement auprès de plusieurs taxi-motos ce qu'ils gagnent réellement sur le créneau 11h-14h30** (pas leur moyenne journalière) avant de proposer un montant — c'est la condition de base pour recruter un livreur pilote, voir [05-risques.md](05-risques.md). Tester avec eux la formule "session garantie" plutôt qu'un paiement à la course, et ajuster jusqu'à trouver un montant qui les fait revenir chaque jour sans qu'on ait à les convaincre à nouveau.
